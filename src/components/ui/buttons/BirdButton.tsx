...
const createStyles = (isHovered: boolean, _isPressing: boolean, isSelected: boolean) =>
  StyleSheet.create({
    ...
    petImage: {
      width: isSelected ? 330 : isHovered ? 260 : 250,
      height: isHovered ? 60 : 50,
      marginLeft: isSelected ? 150 : 100,
    },
    Button: {
...
type BirdButtonProps = PropsWithChildren<{
  title: string;
  filter: string;
...
function BirdButton(props: BirdButtonProps): JSX.Element {
