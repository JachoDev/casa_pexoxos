...
const createStyles = (isHovered: boolean, _isPressing: boolean, isSelected: boolean) =>
  StyleSheet.create({
    ...
    petImage: {
      width: isSelected ? 320 : isHovered ? 250 : 240,
      height: isHovered ? 60 : 50,
      marginRight: isSelected ? 130 : 100,
    },
    dogButton: {
...
type CatButtonProps = PropsWithChildren<{
  title: string;
  filter: string;
...
function CatButton(props: CatButtonProps): JSX.Element {
